...
public class addTariffHome extends BrowserUtils {

    public addTariffHome(){
    ...
    public void setLocalMinutes() throws InterruptedException {
    ...
    public void setVerifyheader(String expectedheader){
        staticWait(5);
        System.out.println(verifyheader.getText());
